...
%does this, however, by pushing complexity into SDN control software itself.
Just as sophisticated compilers are hard to write, but make programming easy, SDN
...
The techniques employed in practice for troubleshooting distributed systems like SDN are
quite primitive; they
essentially involve manual inspection of logs. % in the hope of identifying the relevant inputs.
Here we developed a technique for automatically
...
software under test.
%We believe our technique will be especially valuable for troubleshooting
