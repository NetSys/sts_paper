...
or instrumentation of the control software. Contrary to deterministic replay
approaches, we explore divergent execution paths by dynamically responding
to I/O requests. As far as we know we are the first to achieve these goals.
...
failover logic, broken state machines,
and distributed locking---that we found
