...
We share the common goal of practically improving troubleshooting
...
Using a similar set of technologies as OFRewind, ndb provides a
trace view into the OpenFlow forwarding tables
encountered by historical and current packets in the network. In our
experience we have found that examining low-level forwarding behavior is not
...
Neither of the two projects focuses on the problem of diagnostic information
