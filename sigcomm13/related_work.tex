...
possibilities, we take as input a particular event trace that is known to trigger the
bug, and enumerate subsets of that event trace in the hope of finding shorter
