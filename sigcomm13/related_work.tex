...
Control plane replay tools such as OFRewind~\cite{ofrewind}, and
deterministic replay tools such as liblog~\cite{Geels:2006:RDD:1267359.1267386} allow developers
...
messages between the hosts~\cite{nice}. We chose to avoid state-space explosion
by analyzing errant traces post-hoc.
