...
And unlike human history, it is often possible to find an answer to the
question of ``how we got
into this mess''. In this paper we address the problem of programmatically
answering such questions in the context of software-defined networking.
...
We cope with divergent histories by recording and replaying at the application layer,
...
We have applied \simulator~to three open source SDN control
