...
\colin{Replace Abe with a more preventative example?}
...
triggered the bug (and conversly filter out the extraneous ones).
This would go a long way towards achieving ``automated troubleshooting.''

If you consider the software-defined network as a distributed state machine,
...
We have applied our technique, \simulator, to three open source SDN control
platforms: Floodlight~\cite{bigswitch}, POX~\cite{pox}, and NOX~\cite{nox}.
Of the five bugs we found in a 5 day investigation,
