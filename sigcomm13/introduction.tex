...
Would World War \rom{1} have occurred if Archduke Ferdinand had not been shot?
If it were possible to prune and replay historical events, historians could
experimentally answer questions such as these.

Unlike political history, computer system traces can be pruned and
replayed. As we show in this paper, it is possible to programmatically answer
questions
of the form ``If this event had not been present, would the output have
significantly differed?''.

The ability to programmatically answer such questions is especially useful for bug diagnosis,
a highly expensive and time consuming process. A 2006 survey found
...
Troubleshooting is especially problematic for developers of software-defined
networks. Modern SDN control platforms are highly complex,
