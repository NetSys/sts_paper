...
\begin{itemize}
\item  Our contribution: we're applying delta-debugging to distributed systems -- generalizing across time (no longer a single input file) and space (coordinating multiple machines).
...
\item  We're also not interested in proactively finding bugs (NICE), only reactively.
