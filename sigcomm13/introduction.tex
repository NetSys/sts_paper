...
shot? In the absense of political criticism from the Soviet Union,
would the American civil rights movement have succeeded? That is,
...
In this paper we address the problem of programmatically answering
questions of this form. % in the context of software-defined networks.
...
throughout the distributed system. In this way we can reason about slightly altered
histories by masking over semantically insignificant
information.
