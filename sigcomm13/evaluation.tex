...
\noindent{\bf POX discovery blackhole.} The next bug we encountered involved a
race condition between the discovery module learning about links, and the
routing module installing paths for new flows.
