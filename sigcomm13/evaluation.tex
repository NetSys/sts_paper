...
POX migration blackhole & 4 pod (20 switch) FatTree & 20/20 & 117 (29) & 3 (2) \\
...
In another run of randomly generated inputs we discovered a second blackhole
in POX. Our initial input size was 117 inputs. Before investigating the bug we
...
and this particular routing did not support host migrations. Nonetheless, this
