...
Similar to POX we exercised NOX's routing module (\emph{routing}), since
it depends on a large number of other components.
...
Our initial input size was 358 inputs, a minute's worth of execution.
\Simulator~returned a 58 input MCS. The most salient inputs in the
...
exact root cause with NOX developers, based on the 58 input MCS.
