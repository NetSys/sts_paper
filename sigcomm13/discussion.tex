...
\noindent{\bf Why SDN?}
SDN has several properties that make it particularly amenable to an
...
In future work we plan to experiment with the effectiveness of our
our technique on other control plane systems
which share the same properties, such example NAS controllers or MapReduce job trackers.
