...
\item Are all simulated failures really indistinguishable from actual failures?
...
\item Will this approach work on all control platforms? (is this specific to virtualization?)
\item Will control platforms ever become stable enough that troubleshooting tools become unnecessary?
\end{itemize}
