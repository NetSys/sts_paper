...
supported for POX
and Floodlight}: whenever a log
statement is executed, we
...
the control software is forced to block at internal state transition points
...
\projectname~can be used to generate randomly chosen input
...
The above two use cases are implemented and exercised in \projectname~today.
