...
The main way \projectname~is used is as a simulation and testing framework.
\projectname~gives complete control over event orderings, message drops, node
failures, \etc, which is especially useful for exploring corner cases.
Amin Vahdat of Google describes the value in using their network simulator to
