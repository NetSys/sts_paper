...
implementers of SDN control software. We then clarify the scope of our
technique's use.

\subsection{SDN Control Software Challenges}
...
tenants are upheld at all times make
SDN control software highly complex and bug-prone.

\subsection{Limitations}
\label{subsec:non_goals}
\andi{Move this subsection. Most of these points are not actually non-goals but limitations / trade offs 
of our approach. People won't understand the implications before they know the details of the approach.
Maybe we should state our goal/contributions bigger/in bold in Intro.}

Before diving into the
details, we clarify the scope of our technique's use.
...
achieving efficient simulation of dataplane traffic. \sam{Also, proactive is more common than reactive amongst existing SDN controller frameworks/implementations, so this is a reasonable thing to focus on.}
