...
details, we clarify the scope of our tool's value.

\subsection{Non-Goals}
\label{subsec:non_goals}
\begin{itemize}
% Possibly another one?:
%\projectname{} is a troubleshooting tool, not a debugger; by
...
%line of code causes the error (why?).

% And another:
%We focus on a \emph{proactive} mode of
%operation where forwarding state updates are triggered by policy or topology
%changes, not data-plane events.
