...
\item Soundest solution: peek()
  ...
  \end{itemize}
\item We apply domain knowledge to ensure validity of input sequences. For example, it doesn't make sense to replay a link recovery event if we pruned the link failure event that preceded it.
