...
Our problem differs from that solved by unmodified delta debugging in two dimensions.
...
and cope with alterations to the causal history of an execution.
In \S\ref{sec:architecture}, we describe concrete ways in
...
simulator replays each subsequence selected by the delta debugging algorithm
...
\colin{Paragraph on optimizations}

\eat{ % Cutting this makes me le sad
