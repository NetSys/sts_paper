...
non-deterministic behavior. We therefore simulate the control-plane
behavior of network devices (with support for minimal data-plane behavior)
...
than the original event traces. \colin{Should strengthen this claim. The
controllers we examined must have state machines that are amenable..}
