...
\begin{figure}[t]
    ...
    controllers in the example Floodlight bug. \colin{TODO: broadcast
    notification?}}
\end{figure}
...
successor occurring before it has injected the next input.\colin{Should
...
\colin{Make sure we emphasize that there is no `right answer', since modified
history}
