...
\begin{figure}[t]
    ...
    respresent presence of the blackhole.}
\end{figure}
...
We have developed two event scheduling algorithms to accout for altered
...
injected while still maintaining happens-before contstraints. For example, if $i_2$ and $i_3$ are internal events observed
