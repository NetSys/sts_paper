...
\footnote{Note that delta debugging as presented
in~\cite{Zeller:1999:YMP:318773.318946} assumes that no unresolved test
...
link failure). Their follow-on
paper~\cite{Zeller:2002:SIF:506201.506206} also removes this assumption,
but doing so adds a factor of $N$ to the runtime.}
