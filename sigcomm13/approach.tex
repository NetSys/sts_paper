...
\colin{Shivaram comment: need a paragraph that lays out model. Processes,
inputs, messages, single trace labeled with which event belongs to which
process. We discuss in section }
...
\begin{figure}[t]
    ...
    dataplane behavior in software, and interpose on all communication
    channels.}
\end{figure}
...
\colin{Figure this figure out}
%\begin{wrapfigure}{c}{\linewidth}
%  \centering
%  \includegraphics[height=0.8in]{../diagrams/state_machines/event_sequence.pdf}
%\end{wrapfigure}
...
\colin{Mention Andrew's input type pruning optimization}
