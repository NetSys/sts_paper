...
First, input to SDN controllers is not inserted at a single point in time:
it includes many messages, and depends on subtle causal
relationships within individual controller processes.
Second, the input is spread across space: it depends on causal relationships across
concurrently running nodes. In the rest of this section, we describe how we
