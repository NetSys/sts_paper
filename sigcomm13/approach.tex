...
Both waiting and peeking replay need to support an important case.
As we have proven elsewhere\footnote{URL omitted for anonymity reasons}.
Refer to state machine somewhere.

In the best case, the delta debugging algorithm terminates after
$O(log\,n)$
