The core piece of technical infrastucture we need to realize our approach is a
mechanism to replay execution logs. Building such a replay mechansim comes
...
is an independent and identitically distributed random variable, multiple
