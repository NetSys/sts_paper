...
to automatically filter out inputs to the SDN software (\eg~link failures) \sam{saying ``link failures'' makes it sound like you want to filter out {\em all} link failures}
