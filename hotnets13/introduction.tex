...
These violations could arise from a hardware failure or a policy misconfiguration, and there is active work on developing tools to detect these problems \cite{hsa,atpg,??}. However, such violations could also arise from bugs in the SDN control plane software;  our focus is on trying to troubleshoot this case.  Thus, in what follows we only consider violations caused by SDN software bugs. 
