...
As with any highly complex codebase, software bugs are an unpleasant but ever-present fact-of-life.
...
that these policy violations are rare and are symptoms of an underlying
software bug (such violations could also result from a hardware failure or a
policy misconfiguration, but here we focus violations caused by bugs in the SDN control plane software).
