...
occurred~\cite{tel2000introduction}. {\bf say something more here about happens-before??  what do we use to establish this??}
...
Some internal events that occurred in the original log, and which causally ``happen before'' some external event, may be absent when replaying a subsequence of that log. We therefore wait for expected equivalent internal events, but time out and proceed
