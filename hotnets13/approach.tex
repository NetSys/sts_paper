...
the most obvious way to achieve this goal involves exploring all timings $T$ for each
...
with the following na\"ive scheduling algorithm, even before began modifying
those inputs:
\begin{align*}
t'_0 = 0 \\
