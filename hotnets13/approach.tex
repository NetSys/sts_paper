...
subsequence of the original set of inputs, the reaction of the underlying system
...
(to be described in the next section) interpose on all message channels and
...
Some internal events that occurred in the original log, and which causally ``happen before'' some external event,
