...
\sam{Actually, it's worse than that, if you consider timing (as this new formulation does). $O(2^N)$
only considers event inclusion, but the timings of these events is an infinite space.}
