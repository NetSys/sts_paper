...
implementers of SDN control software.
...
100,000 v-switches in a large datacenter) as a single logical switch for each
tenant. When an entire datacenter network is
...
troubleshooting bugs. We then spend
