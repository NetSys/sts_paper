...
During replay, the simulator may delay or reorder controller-switch or
controller-controller messages to maintain the causality
reflected in the original log.
...
\projectname~also makes use of Open vSwitch~\cite{pfaff2009extending} as an interposition point for
