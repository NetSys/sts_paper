...
%
\noindent{\bf Our Contribution.} Our primary contribution consists in
...
discuss heuristics we have developed that we have empirically shown to work
...
%
\noindent{\bf Log Comprehension.} Model synthesis techniques attempt to summarize log files
...
Model synthesis does not directly modify the logs, although
