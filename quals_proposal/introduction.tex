...
sequences of external events such as failures
on large testbeds.
...
providing any guarentees on the minimality of the output we produce.
...
We start by overviewing related work (\S\ref{sec:related_work}), and end by
