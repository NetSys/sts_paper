...
it translates the (possibly complicated) physical view into a simpler logical view.
...
is prone to the same classes of error
...
keynote~\cite{urs_keynote}, Google's Urs H\"{o}elzle noted that
