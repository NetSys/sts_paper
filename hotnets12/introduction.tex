...
cause some angst, and justifiably, in the industry''. As SDN controllers
are increasingly distributed for scalability, we expect the complexity
challenges to further increase in the future.
