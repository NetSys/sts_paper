The SDN platform's {\it raison d'$\hat{e}$tre} is to 
...
\colin{Reviewer A: I find this statement too strong ``impossible to aggregate
into a single serial execution of the system''.}
...
\colin{review A: is this sound and complete?}
