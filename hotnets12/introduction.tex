...
It is important to place this work in context and scope the problem we are
attacking. First, \simulator{} is a troubleshooting tool, not a debugger; by
this we mean that \simulator{} helps identify and localize network
problems but it does not help identify exactly which
line of code causes the error. Second, \simulator{} is focused on the
...
forwarding tables in the physical switches~\cite{anteater,hsa}, we
