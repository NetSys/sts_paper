...
applies directly to distributed control platforms, does not require analysis
of the control software itself, and is used {\em post-hoc} to
...
Pip~\cite{pip} is a framework for instrumenting general distributed systems
in order to record, display, and check invariants on causal paths throughout the execution of
live system. \Simulator{} observes the causal behavior of the
distributed system in a simulated environment, enabling us to prune events from the
causal paths.
