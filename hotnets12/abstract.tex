...
systems. When control software behaves incorrectly, it is tedious at best, and
intractable at worst for developers to identify the exact events that caused the system to enter
an erroneous state. In this paper we present techniques for automatically inferring the
events from system execution logs that are both necessary and sufficient
for triggering a given control software fault.
