...
determined whether \simulator{} could identify the policy-violation.
Throughout the system execution there were a handful of transient
policy-violations overlapping with the isolation breach. Nonetheless, our
simulator was able to identify the correct policy-violation.
...
\noindent{\bf Floodlight: Distributed controller failover race condition} More complex bugs and race conditions occur when controllers need to be
...
\colin{reviewer B: correspondence is not being checked.}
