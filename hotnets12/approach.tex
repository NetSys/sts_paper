...
detail the (i) distributed logging and analysis infrastructure, (ii) determinstic
replay execution environment, and (iii) violation detection algorithms
necessary for finding the minimal causal sequence.

\subsection{Distributed Logging and Analysis}
...
replay the original event. If it is not possible to distingish the original
