...
\colin{Points to make: CC is a weak condition. CC can replaced by other
deciders that are more powerful. CC intentionally does not require
invariant specifications, which is a hard problem.}
