...
with three new techniques for SDN debugging.
...
\noindent {\it Inconsistency reproduction}: Production software-defined
networks run multiple control servers to achieve scalability and
fault-tolerance. Distributed control gives rise to the same set of coordination
and consistency problems seen in general distributed systems. To capture these
errors, we have designed a preliminary mechanism to capture and reproduce
