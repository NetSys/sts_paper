...
resolving transient errors is a good goal for a second project}
...
components.
\justine{I agree with your statement earlier that replication/consistency is a more
interesting set of bugs. If we say `multicomponent' or 'cross component' or do you think
that will encompass both insights?}
...
essentially need to take snapshots at every state change. Moreover,
            ...
            \justine{How does this come across in CLINT?} \colin{Right now, it
                doesn't. However, when we start dealing with consistency bugs, we will
                    ...
                    \justine{wait, is this a debugging technique or something you would do to stop consistency bugs from happening?}
                    ...
                    detecting and isolating such errors: cross-layer\justine{cross-component?} analysis, and dynamic invariant checking.
