...
Frenetic, POX, and Floodlight. The bug in Frenetic demonstrates 
...
programaticaly prioratize persistent policy-violations and infer their minimal
causal sets. In addition to finding bugs, we show that \projectname{} is able 
to simulate and check large networks quickly enough to allow for interactive
use.
