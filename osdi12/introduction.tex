...
% "The Challenge" sentence is a bit awkward...

% TODO: move this down, right above "In evaluating?"
% TODO: Call out "What, Where, and When" early, and clearly
...
given point in time, where in the control software a problem first developed, and when the triggering event occurred. To accomplish this, 
