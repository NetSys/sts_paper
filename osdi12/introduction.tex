...
\colin{Our framework localizes a region of the two dimensional space: layer vs.
event. HSA helps us get a crisp definition of the policy-violation (scope of
inconsistency in the network, range of inputs that produce it).}

% Make this sound algorithmic

% Term: minimal causal set
