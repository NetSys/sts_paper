...
\tbd{NOTE: not so different -- only in terms of record/replay overhead. And
OFRewind showed that even reactive controllers are tractable, since control
traffic is much smaller than dataplane traffic}
...
and the forwarding plane~\cite{anteater}. \tbd{We are not defining ourselves
in terms of related work -- related work is a way of addressing the
deficiencies of our approach}
