...
incorrect.} \colin{I think we should demphasize cc -- frame it as a ``black
box policy-violation detector for the purposes of casual analysis. Also,
apparently need to do a better job of calling out that correspondence checking
is indeed a weak condition}
...
application layer included?} The routing
...
\colin{As for the simulation-based replay analysis, it isn't clear what you
