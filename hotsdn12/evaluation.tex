...
time to send 1 OFFP\_PORT\_STATUS message and process 5 FLOW\_MOD
messages per switch. The execution completed in 5.846 seconds, well within the
...
\colin{\noindent{\bf Miscellaneous} How do you validate the simulator? Is it sufficiently complex to
