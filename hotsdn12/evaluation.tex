...
as lightweight python objects that communicate with a SDN controller as if they were
true hardware.
...
Finally, note that our correspondence checking algorith can not verify 
