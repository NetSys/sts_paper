...
Figure~\ref{hsa_runtime}. For this analysis we generated fat tree topologies
between 2 and 48 pods wide, with pre-installed PORTLAND~\cite{NiranjanMysore:2009:PSF:1594977.1592575}
routing tables in each switch. Each data point was generated on a single Intel Xeon
2.80GHz core. Note that the number of PORTLAND routing entries per switch scales with the number
of pods in the fat-tree. Note also that we excluded the time to convert
