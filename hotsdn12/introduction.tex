...
from control applications into the underlying SDN platform. The goal of SDN is to provide a stable platform upon which
applications developers can build applications without needing to debug the
underlying platform. However, the evolution of SDN
is far too nascent to provide stability today.
