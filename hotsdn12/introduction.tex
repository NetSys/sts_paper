...
\item We present a principled approach to finding safety violations: correctness iff correspondence \colin{</ how we
solve it>}. This augments logs -- finds the needle in the haystack, handles
global ordering, \etc.
\end{itemize}
