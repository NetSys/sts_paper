...
\noindent{\bf Log Input.} We are given a log $L$ of a system execution generated
...
\noindent{\bf Internal Events.} As stated, the log $(E_L, T_L)$ does not include
...
\noindent{\bf Minimization.} The goal of our work is, when given a log $(E_L,
