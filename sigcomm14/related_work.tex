...
As far as we know we are the first to extend
delta debugging~\cite{Zeller:1999:YMP:318773.318946,Zeller:2002:SIF:506201.506206}
to a distributed system in order to achieve our goal, where test
cases are injected over a period of time rather than at once, and involve
causal relationships between multiple actors.
...
(iii) replay (particularly as applied to non-determinism), and
...
automatically minimize system executions. Moreover, we have designed our
approach to fit naturally into the way distributed systems are developed and
tested today by software engineers.
