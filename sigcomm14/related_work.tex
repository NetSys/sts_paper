...
formal methods such as model checking, in part because model checking suffers from exponential
...
messages between the hosts.} and because large systems comprise
multiple languages that are often not amenable to formal methods. %Rather than exploring all
