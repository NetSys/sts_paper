...
been applied to minimize thread
interleavings~\cite{choi2002isolating,claessen2009finding,huang2012lean} (but
not inputs) leading up to race conditions.
These approaches still involve injecting a single input (the thread schedule) to a
