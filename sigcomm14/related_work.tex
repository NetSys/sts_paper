...
event traces into minimal sequences of inputs.
To achieve this we are the first to our knowledge to extend delta debugging~\cite{Zeller:1999:YMP:318773.318946,Zeller:2002:SIF:506201.506206}
to a distributed system where there is an ongoing sequence of inputs
involving multiple entities rather than a single file fed to a single
entity. Delta debugging has been applied to minimize thread context switches
