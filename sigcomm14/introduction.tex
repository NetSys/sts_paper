...
tenants~\cite{Casado:2010:VNF:1921151.1921162,netvirt}, and
globally optimizing network utilization~\cite{jain2013b4,hong2013achieving}.
...
developing tools to detect these problems~\cite{hsa,Zeng:2012:ATP:2413176.2413205,anteater,libra}. However, such violations
...
Our approach is to prune inputs from the original execution, replay the remaining
...
% TODO: rewrite and/or move this paragraph once we have the improved related work
% section written.
...
set of potentially triggering inputs verges on unmanageable.
Tracing tools such as ndb~\cite{ndb14} provide
...
enables concise policy specifications and significantly more sophisticated testing and troubleshooting tools. Moreover, since SDN
