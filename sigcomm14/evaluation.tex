...
\begin{tabular}{|l||l|l|l|l|l|}
  ...
  \multirow{8}{*}{\rotatebox[origin=c]{90}{\bf Newly Found}} & Pyretic loop & 3 switch mesh & 20/20 & 2 & Yes \\
...
\hline
\hline
\multirow{3}{*}{\rotatebox[origin=c]{90}{\bf Known}} & Floodlight example failover bug & 2 switch mesh & - & 2 & Yes \\
...
troubleshooting real bugs. We found \num{eight} new bugs by fuzz testing five open source
...
The POX application we ran was a layer two routing module (\verb=l2_multi=) that
...
Recall that \projectname~optionally replays subsequences multiple times
throughout delta debugging to
mitigate the effects of non-determinism. We evaluate the effectiveness of this
approach on the minimization a non-deterministic loop created by Floodlight.
Figure~\ref{fig:non-determinism} demonstrates that the size of the resulting MCS decreases
with the number of replays per subsequence. This shows that replaying multiple times is
effective at coping with non-determinism, at the cost of increased runtime.
