...
% Total inputs: 284
% Andi
ONOS distributed database locking & TBD & 3 & Yes \\
% Ahmed
\hline
Known Bugs & - & - & - & - \\
\hline
...
Algorith misimplementation & 3 switch mesh & TBD & 7 & No \\
...
Multithreaded race condition & 10 switch mesh & TBD & TBD & TBD \\
% experiments/trigger_multithreading_bug_mcs
% total original inputs: 1597
% Currently running on c5
...
troubleshoot synthetic and previously known bugs that span a range of bug types encountered in
...
\noindent{\bf POX Premature Handshake.}
...
\noindent{\bf ONOS master election bug.} XXX
