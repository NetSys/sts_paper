...
\begin{tabular}{|l||l|l|l|l|l|}
  ...
  \textbf{Input Size} &
  \textbf{MCS Size} & \textbf{MCS helpful?}  \\\cline{2-6} \hline
...
& NOX discovery loop & 4 switch mesh & 150 & 18 & Not directly \\
% 18/20
% Total inputs: 150
...
& Algorithm misimplementation & 3 switch mesh & 40 & 7 & Not directly \\
...
& Memory Leak & 2 switch mesh & 719 & 30 (M) & Not directly \\
...
and qualitatively relay our experience using MCSes to debug. First,
...
find across across multple fuzz runs that the MCS was always 24
elements.
...
counter some sources of non-determinism by applying the software techniques,
...
The cases where \projectname~was most useful were those were a developer would
have started from
