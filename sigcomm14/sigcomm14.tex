...
\and {\begin{tabular}{cccccc}$^\diamond${\it UC Berkeley} &
$^\dagger${\it Big Switch Networks} & $^\star${\it ICSI} &
$^\text{\o}${\it Tshinghua University} & $^\sharp${\it EPFL} & $^\ddagger${\it USC}\end{tabular}}
}
