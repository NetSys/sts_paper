...
\and Sam Whitlock$^\star$$^\sharp$ % \thanks{ICSI}  %
...
\and {\begin{tabular}{cccccc}$^\diamond${\large\it UC Berkeley} &
$^\dagger${\large\it Big Switch Networks} & $^\star${\large\it ICSI} &
$^\Lambda${\large\it Tshinghua University} & $^\sharp${\large\it EPFL} & $^\ddagger${\large\it USC}\end{tabular}}
}
