...
\and {\begin{tabular}{ccccc}$^\dagger${\large\it UC Berkeley} & $^\diamond${\large\it Big Switch Networks} & $^*${\large\it ICSI} & $^\ddagger${\large\it USC} & $^+${\large\it Tshinghua University}\end{tabular}}
}
