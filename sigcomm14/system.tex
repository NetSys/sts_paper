...
If implementers of technique do not choose to use a snapshotting mechanism,
...
recent snapshot rather than the beginning of the trace can reduce runtime.
...
While we takes as input a single, totally-ordered log of the events in the
