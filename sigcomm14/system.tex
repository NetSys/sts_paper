...
Not doing control plane fingerprinting besides OF, for throughput reasons

How we cause controller partitions (iptables), and other events? Tradeoffs
with interposing on all messages.

How we generate dataplane traffic?
