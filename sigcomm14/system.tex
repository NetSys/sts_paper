...
\begin{figure}[t]
    ...
    network devices, and interpose on all communication
    channels.}
\end{figure}
...
trying to improve get by without coping with non-determinism. In the worst case our techniques leaves the developer ends up
