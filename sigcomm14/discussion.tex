...
SDN control software---both propietary and open source---is in its infancy, which means
that bugs are pervasive.

In terms of an opportunity, SDN's architecture facilitates the implementation of~\projectname. The
...
to the size of the overall network, making it easy to interpose on
messages. Lastly, the control flow of SDN control software is such that it repeatedly returns to
