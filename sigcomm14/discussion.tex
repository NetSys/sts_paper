...
controller platforms were exercised with \projectname~without any modifications.
...
\noindent{\bf Dataflow analysis.} Another avenue for future work is to apply
dataflow
analysis~\cite{kildall1973unified,Lee:2011:TGR:1993498.1993528,tallam2007enabling}
to further prune or preprocess events.
...
\noindent{\bf Enabling Analysis of Production Logs}
