...
The key component of this system is a mock network that can execute the $replay()$ function.
Because we do not have access to operational logs \colin{sounds defensive}, all of our focus is on
discovering bugs in control software using this
mock network and then finding the relevant MCSes that trigger these bugs.
