...
the delta debugging algorithm~\cite{Zeller:1999:YMP:318773.318946} provides a % provably-correct
means of isolating fault-inducing inputs. In our case, we use delta
...
for an overall runtime of $O(n \log n)$ replayed inputs.
