...
\hline
OpenFlow messages & transaction id, cookie, buffer id, statistics \\
Dataplane packets (contained in OpenFlow packet\_outs and packet\_ins) &
all fields except source, destination and payload \\
