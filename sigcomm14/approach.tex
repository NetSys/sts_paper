...
approach to achieving our first task. We can do better by leveraging
%a
...
of the control software. %\eat{: when we replay only a
...
events before we replay each subsequence. Our algorithm (called PEEK) for inferring the
