...
timing of the inputs within those subsequences during $replay()$ is crucial for reliably
reproducing the
...
of the control software induced by the modified inputs. %\eat{: when we replay only a
