...
\begin{tabular}{|l|l|}
\hline
Link failure/recovery & Switch failure/recovery \\
\hline
Controller failure/recovery & Controller partition \\
\hline
Dataplane packet injection & Dataplane packet drop \\
\hline
Dataplane packet delay & Host migration \\
\hline
Control message delay & Non-deterministic TCAMs \\
\hline
\end{tabular}
...
We show four examples of masked values
...
\hline
packet\_out/in payload &
everything but src, dst, data \\
\hline
